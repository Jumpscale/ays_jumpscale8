...
class Actions(ActionsBase):
    ...
    def init(self, serviceObj, args):
        ...
        args['param.osis.client.addr'] = serv.hrd.get("tcp.addr")
        args['param.osis.client.port'] = 5544
        args['param.osis.client.login'] = 'root'
        args['param.osis.client.passwd'] = serv.hrd.get('param.osis.superadmin.passwd')
